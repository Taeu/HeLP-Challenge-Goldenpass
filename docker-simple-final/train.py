...
import cv2
import psutil
from model import find_patches_from_slide, predict_batch_from_model, predict_from_model, InceptionV3, simple_model
...
# model = InceptionV3(pretrained_weights = 'i_5.h5')
...
samples = all_samples.sample(50000, random_state=42)
