...
from train import find_pathes_from_slide, read_test_data_path, predict_from_model, simple_model
...
def gen_imgs_test(slide_path, truth_path, samples, batch_size, patch_size = PATCH_SIZE, shuffle=True):
